...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:zn,depthTest:!1,depthWrite:!1})}function tc(){return new wt({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Qa(),fragmentShader:`
		...
		`,blending:zn,depthTest:!1,depthWrite:!1})}function nc(){return new wt({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Qa(),fragmentShader:`
	...
	`}function Dm(o){let e=new WeakMap,t=null;function n(a){if(a&&a.isTexture){const l=a.mapping,h=l===ea||l===ta,u=l===Qi||l===es;if(h||u){let c=e.get(a);const d=c!==void 0?c.texture.pmremVersion:0;if(a.isRenderTargetTexture&&a.pmremVersion!==d)return t===null&&(t=new Ql(o)),c=h?t.fromEquirectangular(a,c):t.fromCubemap(a,c),c.texture.pmremVersion=a.pmremVersion,e.set(a,c),c.texture;if(c!==void 0)return c.texture;{const f=a.image;return h&&f&&f.height>0||u&&f&&i(f)?(t===null&&(t=new Ql(o)),c=h?t.fromEquirectangular(a):t.fromCubemap(a),c.texture.pmremVersion=a.pmremVersion,e.set(a,c),a.addEventListener("dispose",s),c.texture):null}}}return a}function i(a){let l=0;const h=6;for(let u=0;u<h;u++)a[u]!==void 0&&l++;return l===h}function s(a){const l=a.target;l.removeEventListener("dispose",s);const h=e.get(l);h!==void 0&&(e.delete(l),h.dispose())}function r(){e=new WeakMap,t!==null&&(t.dispose(),t=null)}return{get:n,dispose:r}}function Im(o){const e={};function t(n){if(e[n]!==void 0)return e[n];let i;switch(n){case"WEBGL_depth_texture":i=o.getExtension("WEBGL_depth_texture")||o.getExtension("MOZ_WEBGL_depth_texture")||o.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":i=o.getExtension("EXT_texture_filter_anisotropic")||o.getExtension("MOZ_EXT_texture_filter_anisotropic")||o.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":i=o.getExtension("WEBGL_compressed_texture_s3tc")||o.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||o.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":i=o.getExtension("WEBGL_compressed_texture_pvrtc")||o.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:i=o.getExtension(n)}return e[n]=i,i}return{has:function(n){return t(n)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(n){const i=t(n);return i===null&&Ps("THREE.WebGLRenderer: "+n+" extension not supported."),i}}}function Nm(o,e,t,n){const i={},s=new WeakMap;function r(c){const d=c.target;d.index!==null&&e.remove(d.index);for(const g in d.attributes)e.remove(d.attributes[g]);for(const g in d.morphAttributes){const _=d.morphAttributes[g];for(let m=0,p=_.length;m<p;m++)e.remove(_[m])}d.removeEventListener("dispose",r),delete i[d.id];const f=s.get(d);f&&(e.remove(f),s.delete(d)),n.releaseStatesOfGeometry(d),d.isInstancedBufferGeometry===!0&&delete d._maxInstanceCount,t.memory.geometries--}function a(c,d){return i[d.id]===!0||(d.addEventListener("dispose",r),i[d.id]=!0,t.memory.geometries++),d}function l(c){const d=c.attributes;for(const g in d)e.update(d[g],o.ARRAY_BUFFER);const f=c.morphAttributes;for(const g in f){const _=f[g];for(let m=0,p=_.length;m<p;m++)e.update(_[m],o.ARRAY_BUFFER)}}function h(c){const d=[],f=c.index,g=c.attributes.position;let _=0;if(f!==null){const x=f.array;_=f.version;for(let M=0,v=x.length;M<v;M+=3){const P=x[M+0],C=x[M+1],E=x[M+2];d.push(P,C,C,E,E,P)}}else if(g!==void 0){const x=g.array;_=g.version;for(let M=0,v=x.length/3-1;M<v;M+=3){const P=M+0,C=M+1,E=M+2;d.push(P,C,C,E,E,P)}}else return;const m=new(Ah(d)?Dh:Lh)(d,1);m.version=_;const p=s.get(c);p&&e.remove(p),s.set(c,m)}function u(c){const d=s.get(c);if(d){const f=c.index;f!==null&&d.version<f.version&&h(c)}else h(c);return s.get(c)}return{get:a,update:l,getWireframeAttribute:u}}function Um(o,e,t){let n;function i(d){n=d}let s,r;function a(d){s=d.type,r=d.bytesPerElement}function l(d,f){o.drawElements(n,f,s,d*r),t.update(f,n,1)}function h(d,f,g){g!==0&&(o.drawElementsInstanced(n,f,s,d*r,g),t.update(f,n,g))}function u(d,f,g){if(g===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(n,f,0,s,d,0,g);let m=0;for(let p=0;p<g;p++)m+=f[p];t.update(m,n,1)}function c(d,f,g,_){if(g===0)return;const m=e.get("WEBGL_multi_draw");if(m===null)for(let p=0;p<d.length;p++)h(d[p]/r,f[p],_[p]);else{m.multiDrawElementsInstancedWEBGL(n,f,0,s,d,0,_,0,g);let p=0;for(let x=0;x<g;x++)p+=f[x]*_[x];t.update(p,n,1)}}this.setMode=i,this.setIndex=a,this.render=l,this.renderInstances=h,this.renderMultiDraw=u,this.renderMultiDrawInstances=c}function Bm(o){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function n(s,r,a){switch(t.calls++,r){case o.TRIANGLES:t.triangles+=a*(s/3);break;case o.LINES:t.lines+=a*(s/2);break;case o.LINE_STRIP:t.lines+=a*(s-1);break;case o.LINE_LOOP:t.lines+=a*s;break;case o.POINTS:t.points+=a*s;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",r);break}}function i(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:i,update:n}}function Fm(o,e,t){const n=new WeakMap,i=new Ze;function s(r,a,l){const h=r.morphTargetInfluences,u=a.morphAttributes.position||a.morphAttributes.normal||a.morphAttributes.color,c=u!==void 0?u.length:0;let d=n.get(a);if(d===void 0||d.count!==c){let S=function(){L.dispose(),n.delete(a),a.removeEventListener("dispose",S)};var f=S;d!==void 0&&d.texture.dispose();const g=a.morphAttributes.position!==void 0,_=a.morphAttributes.normal!==void 0,m=a.morphAttributes.color!==void 0,p=a.morphAttributes.position||[],x=a.morphAttributes.normal||[],M=a.morphAttributes.color||[];let v=0;g===!0&&(v=1),_===!0&&(v=2),m===!0&&(v=3);let P=a.attributes.position.count*v,C=1;P>e.maxTextureSize&&(C=Math.ceil(P/e.maxTextureSize),P=e.maxTextureSize);const E=new Float32Array(P*C*4*c),L=new Rh(E,P,C,c);L.type=dn,L.needsUpdate=!0;const w=v*4;for(let R=0;R<c;R++){const D=p[R],I=x[R],k=M[R],X=P*C*4*R;for(let q=0;q<D.count;q++){const J=q*w;g===!0&&(i.fromBufferAttribute(D,q),E[X+J+0]=i.x,E[X+J+1]=i.y,E[X+J+2]=i.z,E[X+J+3]=0),_===!0&&(i.fromBufferAttribute(I,q),E[X+J+4]=i.x,E[X+J+5]=i.y,E[X+J+6]=i.z,E[X+J+7]=0),m===!0&&(i.fromBufferAttribute(k,q),E[X+J+8]=i.x,E[X+J+9]=i.y,E[X+J+10]=i.z,E[X+J+11]=k.itemSize===4?i.w:1)}}d={count:c,texture:L,size:new se(P,C)},n.set(a,d),a.addEventListener("dispose",S)}if(r.isInstancedMesh===!0&&r.morphTexture!==null)l.getUniforms().setValue(o,"morphTexture",r.morphTexture,t);else{let g=0;for(let m=0;m<h.length;m++)g+=h[m];const _=a.morphTargetsRelative?1:1-g;l.getUniforms().setValue(o,"morphTargetBaseInfluence",_),l.getUniforms().setValue(o,"morphTargetInfluences",h)}l.getUniforms().setValue(o,"morphTargetsTexture",d.texture,t),l.getUniforms().setValue(o,"morphTargetsTextureSize",d.size)}return{update:s}}function Om(o,e,t,n){let i=new WeakMap;function s(l){const h=n.render.frame,u=l.geometry,c=e.get(l,u);if(i.get(c)!==h&&(e.update(c),i.set(c,h)),l.isInstancedMesh&&(l.hasEventListener("dispose",a)===!1&&l.addEventListener("dispose",a),i.get(l)!==h&&(t.update(l.instanceMatrix,o.ARRAY_BUFFER),l.instanceColor!==null&&t.update(l.instanceColor,o.ARRAY_BUFFER),i.set(l,h))),l.isSkinnedMesh){const d=l.skeleton;i.get(d)!==h&&(d.update(),i.set(d,h))}return c}function r(){i=new WeakMap}function a(l){const h=l.target;h.removeEventListener("dispose",a),t.remove(h.instanceMatrix),h.instanceColor!==null&&t.remove(h.instanceColor)}return{update:s,dispose:r}}class Fh extends Tt{constructor(e,t,n,i,s,r,a,l,h,u=Ki){if(u!==Ki&&u!==is)throw new Error("DepthTexture format must be either THREE.DepthFormat or THREE.DepthStencilFormat");n===void 0&&u===Ki&&(n=Mi),n===void 0&&u===is&&(n=ns),super(null,i,s,r,a,l,u,n,h),this.isDepthTexture=!0,this.image={width:e,height:t},this.magFilter=a!==void 0?a:zt,this.minFilter=l!==void 0?l:zt,this.flipY=!1,this.generateMipmaps=!1,this.compareFunction=null}copy(e){return super.copy(e),this.compareFunction=e.compareFunction,this}toJSON(e){const t=super.toJSON(e);return this.compareFunction!==null&&(t.compareFunction=this.compareFunction),t}}const Oh=new Tt,ic=new Fh(1,1),kh=new Rh,zh=new Td,Gh=new Uh,sc=[],rc=[],oc=new Float32Array(16),ac=new Float32Array(9),lc=new Float32Array(4);function hs(o,e,t){const n=o[0];if(n<=0||n>0)return o;const i=e*t;let s=sc[i];if(s===void 0&&(s=new Float32Array(i),sc[i]=s),e!==0){n.toArray(s,0);for(let r=1,a=0;r!==e;++r)a+=t,o[r].toArray(s,a)}return s}function Et(o,e){if(o.length!==e.length)return!1;for(let t=0,n=o.length;t<n;t++)if(o[t]!==e[t])return!1;return!0}function At(o,e){for(let t=0,n=e.length;t<n;t++)o[t]=e[t]}function Yr(o,e){let t=rc[e];t===void 0&&(t=new Int32Array(e),rc[e]=t);for(let n=0;n!==e;++n)t[n]=o.allocateTextureUnit();return t}function km(o,e){const t=this.cache;t[0]!==e&&(o.uniform1f(this.addr,e),t[0]=e)}function zm(o,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(o.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Et(t,e))return;o.uniform2fv(this.addr,e),At(t,e)}}function Gm(o,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(o.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(o.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(Et(t,e))return;o.uniform3fv(this.addr,e),At(t,e)}}function Hm(o,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(o.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Et(t,e))return;o.uniform4fv(this.addr,e),At(t,e)}}function Vm(o,e){const t=this.cache,n=e.elements;if(n===void 0){if(Et(t,e))return;o.uniformMatrix2fv(this.addr,!1,e),At(t,e)}else{if(Et(t,n))return;lc.set(n),o.uniformMatrix2fv(this.addr,!1,lc),At(t,n)}}function Wm(o,e){const t=this.cache,n=e.elements;if(n===void 0){if(Et(t,e))return;o.uniformMatrix3fv(this.addr,!1,e),At(t,e)}else{if(Et(t,n))return;ac.set(n),o.uniformMatrix3fv(this.addr,!1,ac),At(t,n)}}function Xm(o,e){const t=this.cache,n=e.elements;if(n===void 0){if(Et(t,e))return;o.uniformMatrix4fv(this.addr,!1,e),At(t,e)}else{if(Et(t,n))return;oc.set(n),o.uniformMatrix4fv(this.addr,!1,oc),At(t,n)}}function qm(o,e){const t=this.cache;t[0]!==e&&(o.uniform1i(this.addr,e),t[0]=e)}function Ym(o,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(o.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Et(t,e))return;o.uniform2iv(this.addr,e),At(t,e)}}function jm(o,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(o.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(Et(t,e))return;o.uniform3iv(this.addr,e),At(t,e)}}function Km(o,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(o.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Et(t,e))return;o.uniform4iv(this.addr,e),At(t,e)}}function $m(o,e){const t=this.cache;t[0]!==e&&(o.uniform1ui(this.addr,e),t[0]=e)}function Zm(o,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(o.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Et(t,e))return;o.uniform2uiv(this.addr,e),At(t,e)}}function Jm(o,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(o.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(Et(t,e))return;o.uniform3uiv(this.addr,e),At(t,e)}}function Qm(o,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(o.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Et(t,e))return;o.uniform4uiv(this.addr,e),At(t,e)}}function eg(o,e,t){const n=this.cache,i=t.allocateTextureUnit();n[0]!==i&&(o.uniform1i(this.addr,i),n[0]=i);let s;this.type===o.SAMPLER_2D_SHADOW?(ic.compareFunction=Eh,s=ic):s=Oh,t.setTexture2D(e||s,i)}function tg(o,e,t){const n=this.cache,i=t.allocateTextureUnit();n[0]!==i&&(o.uniform1i(this.addr,i),n[0]=i),t.setTexture3D(e||zh,i)}function ng(o,e,t){const n=this.cache,i=t.allocateTextureUnit();n[0]!==i&&(o.uniform1i(this.addr,i),n[0]=i),t.setTextureCube(e||Gh,i)}function ig(o,e,t){const n=this.cache,i=t.allocateTextureUnit();n[0]!==i&&(o.uniform1i(this.addr,i),n[0]=i),t.setTexture2DArray(e||kh,i)}function sg(o){switch(o){case 5126:return km;case 35664:return zm;case 35665:return Gm;case 35666:return Hm;case 35674:return Vm;case 35675:return Wm;case 35676:return Xm;case 5124:case 35670:return qm;case 35667:case 35671:return Ym;case 35668:case 35672:return jm;case 35669:case 35673:return Km;case 5125:return $m;case 36294:return Zm;case 36295:return Jm;case 36296:return Qm;case 35678:case 36198:case 36298:case 36306:case 35682:return eg;case 35679:case 36299:case 36307:return tg;case 35680:case 36300:case 36308:case 36293:return ng;case 36289:case 36303:case 36311:case 36292:return ig}}function rg(o,e){o.uniform1fv(this.addr,e)}function og(o,e){const t=hs(e,this.size,2);o.uniform2fv(this.addr,t)}function ag(o,e){const t=hs(e,this.size,3);o.uniform3fv(this.addr,t)}function lg(o,e){const t=hs(e,this.size,4);o.uniform4fv(this.addr,t)}function cg(o,e){const t=hs(e,this.size,4);o.uniformMatrix2fv(this.addr,!1,t)}function hg(o,e){const t=hs(e,this.size,9);o.uniformMatrix3fv(this.addr,!1,t)}function ug(o,e){const t=hs(e,this.size,16);o.uniformMatrix4fv(this.addr,!1,t)}function dg(o,e){o.uniform1iv(this.addr,e)}function fg(o,e){o.uniform2iv(this.addr,e)}function pg(o,e){o.uniform3iv(this.addr,e)}function mg(o,e){o.uniform4iv(this.addr,e)}function gg(o,e){o.uniform1uiv(this.addr,e)}function _g(o,e){o.uniform2uiv(this.addr,e)}function vg(o,e){o.uniform3uiv(this.addr,e)}function xg(o,e){o.uniform4uiv(this.addr,e)}function yg(o,e,t){const n=this.cache,i=e.length,s=Yr(t,i);Et(n,s)||(o.uniform1iv(this.addr,s),At(n,s));for(let r=0;r!==i;++r)t.setTexture2D(e[r]||Oh,s[r])}function Mg(o,e,t){const n=this.cache,i=e.length,s=Yr(t,i);Et(n,s)||(o.uniform1iv(this.addr,s),At(n,s));for(let r=0;r!==i;++r)t.setTexture3D(e[r]||zh,s[r])}function Sg(o,e,t){const n=this.cache,i=e.length,s=Yr(t,i);Et(n,s)||(o.uniform1iv(this.addr,s),At(n,s));for(let r=0;r!==i;++r)t.setTextureCube(e[r]||Gh,s[r])}function wg(o,e,t){const n=this.cache,i=e.length,s=Yr(t,i);Et(n,s)||(o.uniform1iv(this.addr,s),At(n,s));for(let r=0;r!==i;++r)t.setTexture2DArray(e[r]||kh,s[r])}function Tg(o){switch(o){case 5126:return rg;case 35664:return og;case 35665:return ag;case 35666:return lg;case 35674:return cg;case 35675:return hg;case 35676:return ug;case 5124:case 35670:return dg;case 35667:case 35671:return fg;case 35668:case 35672:return pg;case 35669:case 35673:return mg;case 5125:return gg;case 36294:return _g;case 36295:return vg;case 36296:return xg;case 35678:case 36198:case 36298:case 36306:case 35682:return yg;case 35679:case 36299:case 36307:return Mg;case 35680:case 36300:case 36308:case 36293:return Sg;case 36289:case 36303:case 36311:case 36292:return wg}}class bg{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.setValue=sg(t.type)}}class Eg{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=Tg(t.type)}}class Ag{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,n){const i=this.seq;for(let s=0,r=i.length;s!==r;++s){const a=i[s];a.setValue(e,t[a.id],n)}}}const bo=/(\w+)(\])?(\[|\.)?/g;function cc(o,e){o.seq.push(e),o.map[e.id]=e}function Cg(o,e,t){const n=o.name,i=n.length;for(bo.lastIndex=0;;){const s=bo.exec(n),r=bo.lastIndex;let a=s[1];const l=s[2]==="]",h=s[3];if(l&&(a=a|0),h===void 0||h==="["&&r+2===i){cc(t,h===void 0?new bg(a,o,e):new Eg(a,o,e));break}else{let c=t.map[a];c===void 0&&(c=new Ag(a),cc(t,c)),t=c}}}class Ur{constructor(e,t){this.seq=[],this.map={};const n=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let i=0;i<n;++i){const s=e.getActiveUniform(t,i),r=e.getUniformLocation(t,s.name);Cg(s,r,this)}}setValue(e,t,n,i){const s=this.map[t];s!==void 0&&s.setValue(e,n,i)}setOptional(e,t,n){const i=t[n];i!==void 0&&this.setValue(e,n,i)}static upload(e,t,n,i){for(let s=0,r=t.length;s!==r;++s){const a=t[s],l=n[a.id];l.needsUpdate!==!1&&a.setValue(e,l.value,i)}}static seqWithValue(e,t){const n=[];for(let i=0,s=e.length;i!==s;++i){const r=e[i];r.id in t&&n.push(r)}return n}}function hc(o,e,t){const n=o.createShader(e);return o.shaderSource(n,t),o.compileShader(n),n}const Rg=37297;let Pg=0;function Lg(o,e){const t=o.split(`
`),n=[],i=Math.max(e-6,0),s=Math.min(e+6,t.length);for(let r=i;r<s;r++){const a=r+1;n.push(`${a===e?">":" "} ${a}: ${t[r]}`)}return n.join(`
`)}const uc=new ke;function Dg(o){Xe._getMatrix(uc,Xe.workingColorSpace,o);const e=`mat3( ${uc.elements.map(t=>t.toFixed(4))} )`;switch(Xe.getTransfer(o)){case Xr:return[e,"LinearTransferOETF"];case it:return[e,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space: ",o),[e,"LinearTransferOETF"]}}function dc(o,e,t){const n=o.getShaderParameter(e,o.COMPILE_STATUS),i=o.getShaderInfoLog(e).trim();if(n&&i==="")return"";const s=/ERROR: 0:(\d+)/.exec(i);if(s){const r=parseInt(s[1]);return t.toUpperCase()+`

`+i+`

`+Lg(o.getShaderSource(e),r)}else return i}function Ig(o,e){const t=Dg(e);return[`vec4 ${o}( vec4 value ) {`,`	return ${t[1]}( vec4( value.rgb * ${t[0]}, value.a ) );`,"}"].join(`
`)}function Ng(o,e){let t;switch(e){case lh:t="Linear";break;case ch:t="Reinhard";break;case hh:t="Cineon";break;case Ga:t="ACESFilmic";break;case uh:t="AgX";break;case dh:t="Neutral";break;case Bu:t="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+o+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const fr=new A;function Ug(){Xe.getLuminanceCoefficients(fr);const o=fr.x.toFixed(4),e=fr.y.toFixed(4),t=fr.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${o}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
`)}function Bg(o){return[o.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",o.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(Ls).join(`
`)}function Fg(o){const e=[];for(const t in o){const n=o[t];n!==!1&&e.push("#define "+t+" "+n)}return e.join(`
`)}function Og(o,e){const t={},n=o.getProgramParameter(e,o.ACTIVE_ATTRIBUTES);for(let i=0;i<n;i++){const s=o.getActiveAttrib(e,i),r=s.name;let a=1;s.type===o.FLOAT_MAT2&&(a=2),s.type===o.FLOAT_MAT3&&(a=3),s.type===o.FLOAT_MAT4&&(a=4),t[r]={type:s.type,location:o.getAttribLocation(e,r),locationSize:a}}return t}function Ls(o){return o!==""}function fc(o,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return o.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function pc(o,e){return o.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const kg=/^[ \t]*#include +<([\w\d./]+)>/gm;function Pa(o){return o.replace(kg,Gg)}const zg=new Map;function Gg(o,e){let t=Ge[e];if(t===void 0){const n=zg.get(e);if(n!==void 0)t=Ge[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,n);else throw new Error("Can not resolve #include <"+e+">")}return Pa(t)}const Hg=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function mc(o){return o.replace(Hg,Vg)}function Vg(o,e,t,n){let i="";for(let s=parseInt(e);s<parseInt(t);s++)i+=n.replace(/\[\s*i\s*\]/g,"[ "+s+" ]").replace(/UNROLLED_LOOP_INDEX/g,s);return i}function gc(o){let e=`precision ${o.precision} float;
...
#define LOW_PRECISION`),e}function Wg(o){let e="SHADOWMAP_TYPE_BASIC";return o.shadowMapType===rh?e="SHADOWMAP_TYPE_PCF":o.shadowMapType===oh?e="SHADOWMAP_TYPE_PCF_SOFT":o.shadowMapType===Bn&&(e="SHADOWMAP_TYPE_VSM"),e}function Xg(o){let e="ENVMAP_TYPE_CUBE";if(o.envMap)switch(o.envMapMode){case Qi:case es:e="ENVMAP_TYPE_CUBE";break;case Wr:e="ENVMAP_TYPE_CUBE_UV";break}return e}function qg(o){let e="ENVMAP_MODE_REFLECTION";if(o.envMap)switch(o.envMapMode){case es:e="ENVMAP_MODE_REFRACTION";break}return e}function Yg(o){let e="ENVMAP_BLENDING_NONE";if(o.envMap)switch(o.combine){case ah:e="ENVMAP_BLENDING_MULTIPLY";break;case Nu:e="ENVMAP_BLENDING_MIX";break;case Uu:e="ENVMAP_BLENDING_ADD";break}return e}function jg(o){const e=o.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:n,maxMip:t}}function Kg(o,e,t,n){const i=o.getContext(),s=t.defines;let r=t.vertexShader,a=t.fragmentShader;const l=Wg(t),h=Xg(t),u=qg(t),c=Yg(t),d=jg(t),f=Bg(t),g=Fg(s),_=i.createProgram();let m,p,x=t.glslVersion?"#version "+t.glslVersion+`
...
`)+`
`+p);const M=x+m+r,v=x+p+a,P=hc(i,i.VERTEX_SHADER,M),C=hc(i,i.FRAGMENT_SHADER,v);i.attachShader(_,P),i.attachShader(_,C),t.index0AttributeName!==void 0?i.bindAttribLocation(_,0,t.index0AttributeName):t.morphTargets===!0&&i.bindAttribLocation(_,0,"position"),i.linkProgram(_);function E(R){if(o.debug.checkShaderErrors){const D=i.getProgramInfoLog(_).trim(),I=i.getShaderInfoLog(P).trim(),k=i.getShaderInfoLog(C).trim();let X=!0,q=!0;if(i.getProgramParameter(_,i.LINK_STATUS)===!1)if(X=!1,typeof o.debug.onShaderError=="function")o.debug.onShaderError(i,_,P,C);else{const J=dc(i,P,"vertex"),V=dc(i,C,"fragment");console.error("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(_,i.VALIDATE_STATUS)+`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}}cs.BlurDirectionX=new se(1,0);cs.BlurDirectionY=new se(0,1);const U_={name:"OutputShader",uniforms:{tDiffuse:{value:null},toneMappingExposure:{value:1}},vertexShader:`
		...
		}`};class B_ extends ps{constructor(){super();const e=U_;this.uniforms=Gs.clone(e.uniforms),this.material=new $0({name:e.name,uniforms:this.uniforms,vertexShader:e.vertexShader,fragmentShader:e.fragmentShader}),this.fsQuad=new fl(this.material),this._outputColorSpace=null,this._toneMapping=null}render(e,t,n){this.uniforms.tDiffuse.value=n.texture,this.uniforms.toneMappingExposure.value=e.toneMappingExposure,(this._outputColorSpace!==e.outputColorSpace||this._toneMapping!==e.toneMapping)&&(this._outputColorSpace=e.outputColorSpace,this._toneMapping=e.toneMapping,this.material.defines={},Xe.getTransfer(this._outputColorSpace)===it&&(this.material.defines.SRGB_TRANSFER=""),this._toneMapping===lh?this.material.defines.LINEAR_TONE_MAPPING="":this._toneMapping===ch?this.material.defines.REINHARD_TONE_MAPPING="":this._toneMapping===hh?this.material.defines.CINEON_TONE_MAPPING="":this._toneMapping===Ga?this.material.defines.ACES_FILMIC_TONE_MAPPING="":this._toneMapping===uh?this.material.defines.AGX_TONE_MAPPING="":this._toneMapping===dh&&(this.material.defines.NEUTRAL_TONE_MAPPING=""),this.material.needsUpdate=!0),this.renderToScreen===!0?(e.setRenderTarget(null),this.fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this.fsQuad.render(e))}dispose(){this.material.dispose(),this.fsQuad.dispose()}}class F_{constructor(e){this.canvas=e,this.time=0,this._initRenderer(),this._initScene(),this._initCamera(),this._initLighting(),this._initPostProcessing(),this.entities=[]}_initRenderer(){this.renderer=new C0({canvas:this.canvas,antialias:!0,powerPreference:"high-performance",stencil:!1}),this.renderer.setSize(window.innerWidth,window.innerHeight),this.renderer.setPixelRatio(Math.min(window.devicePixelRatio,1.5)),this.renderer.outputColorSpace=Rt,this.renderer.toneMapping=Ga,this.renderer.toneMappingExposure=1.15,this.renderer.shadowMap.enabled=!0,this.renderer.shadowMap.type=oh}_initPostProcessing(){const e=this.renderer.getDrawingBufferSize(new se),t=new nn(e.width,e.height,{type:Mn});this.composer=new D_(this.renderer,t);const n=new I_(this.scene,this.camera);this.composer.addPass(n);const i=new cs(new se(window.innerWidth,window.innerHeight),.25,.8,.9);this.composer.addPass(i);const s=new B_;this.composer.addPass(s)}_initScene(){this.scene=new R0,this._buildSkyDome(),this.scene.fog=new jr(13164784,.0015)}_buildSkyDome(){const e=new rn(800,32,15),t=new wt({uniforms:{topColor:{value:new le(26333)},horizonColor:{value:new le(8900331)},bottomColor:{value:new le(16774614)},sunColor:{value:new le(16770229)},sunDirection:{value:new A(.4,.5,-.3).normalize()},offset:{value:20},exponent:{value:.5}},vertexShader:`
        varying vec3 vWorldPosition;
      ...
      `,transparent:!0,depthWrite:!1});for(let i=0;i<Nv;i++){const s=new Re(this._blobGeo,this._blobMat);s.visible=!1,s.castShadow=!0,this.scene.add(s),this.blobs.push({mesh:s,velocity:new A,active:!1,damage:0,tickDamage:0});const r=new Wt(zo*2,zo*2,12,12);r.rotateX(-Math.PI/2);const a=new Re(r,this._poisonMat);a.visible=!1,this.scene.add(a),this.poisonAreas.push({mesh:a,active:!1,timer:0,tickDamage:0,tickTimer:0})}}reset(){for(const e of this.blobs)e.active=!1,e.mesh&&(e.mesh.visible=!1);for(const e of this.poisonAreas)e.active=!1,e.mesh&&(e.mesh.visible=!1),e.timer=0,e.tickTimer=0}throwBlob(e,t,n,i,s){const r=this.blobs.find(d=>!d.active);if(!r)return;r.active=!0,r.mesh.visible=!0,r.mesh.position.copy(e),r.damage=n,r.tickDamage=i,r.puddleDuration=typeof s=="number"?s:ih;const a=new A().subVectors(t,e),h=a.length()/20;a.normalize(),r.velocity.x=a.x*20,r.velocity.z=a.z*20;const c=(t.y-e.y+.5*30*h*h)/h;r.velocity.y=c}_spawnPoisonArea(e,t,n=1,i){const s=this.poisonAreas.find(r=>!r.active);s&&(s.active=!0,s.mesh.visible=!0,s.mesh.position.copy(e),s.mesh.scale.set(.1,1,.1),s.targetScale=n,s.timer=typeof i=="number"?i:ih,s.tickDamage=t,s.tickTimer=0)}update(e,t,n){const i=[];for(const a of this.blobs){if(!a.active)continue;if(a.velocity.y-=30*e,a.mesh.position.addScaledVector(a.velocity,e),a.mesh.rotation.x+=e*5,a.mesh.rotation.y+=e*3,n&&n.loaded&&a.mesh.position.distanceTo(n.position)<4){i.push({damage:a.damage}),this._spawnPoisonArea(a.mesh.position,a.tickDamage,1,a.puddleDuration),a.active=!1,a.mesh.visible=!1;continue}const l=t.getTerrainHeight(a.mesh.position.x,a.mesh.position.z);a.mesh.position.y<=l&&(a.mesh.position.y=l,this._spawnPoisonArea(a.mesh.position,a.tickDamage,1,a.puddleDuration),a.active=!1,a.mesh.visible=!1)}let r=0;for(const a of this.poisonAreas){if(!a.active)continue;if(a.timer-=e,a.timer<=0){a.active=!1,a.mesh.visible=!1;continue}const l=a.targetScale||1;a.mesh.scale.x<l&&(a.mesh.scale.x=Math.min(l,a.mesh.scale.x+e*5*l),a.mesh.scale.z=a.mesh.scale.x);const h=.9;a.mesh.material.uniforms&&(a.mesh.material.uniforms.opacity.value=h);const u=a.mesh.geometry.attributes.position,c=a.mesh.scale.x,d=a.mesh.position.x,f=a.mesh.position.z,g=a.mesh.position.y;for(let _=0;_<u.count;_++){const m=u.getX(_),p=u.getZ(_),x=d+m*c,M=f+p*c,v=t.getTerrainHeight(x,M);u.setY(_,(v-g)/c+.1)}if(u.needsUpdate=!0,n&&n.loaded&&!n.isAirborne&&a.mesh.scale.x>l*.5){const _=Math.pow(n.position.x-a.mesh.position.x,2)+Math.pow(n.position.z-a.mesh.position.z,2),m=zo*a.mesh.scale.x;_<m*m&&(a.tickTimer-=e,a.tickTimer<=0&&(r+=a.tickDamage,a.tickTimer=.5))}}return r>0&&i.push({damage:r}),i}}const Go=["pistol","shotgun","charger"],Ho={pistol:"Pistol",shotgun:"Shotgun",charger:"Charger"};class Bv{constructor(){this.isActive=!1,this._overlay=null,this._resolve=null,this._wavesCompleted=0}onWaveComplete(){return this._wavesCompleted++,this._wavesCompleted%2===0}reset(){if(this._wavesCompleted=0,this.isActive=!1,this._overlay){try{this._overlay.remove()}catch{}this._overlay=null}this._resolve=null}show(e,t,n){return this.isActive=!0,this.crab=e,this.weapons=t,this.burrowManager=n,this._buildUI(),new Promise(i=>{this._resolve=i})}_buildUI(){this._overlay&&this._overlay.remove();const e=document.createElement("div");e.className="shop-overlay",e.innerHTML=`
    ...
    `,document.body.appendChild(e),this._overlay=e,this._renderCards(),e.querySelector("#shop-done-btn").addEventListener("click",()=>{this._close()})}_renderCards(){const e=this._overlay.querySelector("#shop-cards");e.innerHTML="";const t=this.crab,n=[],i=t.weaponType,s=t.weaponLevels[i]||1,r=s>=10,a=20+(s-1)*15;n.push({id:"weapon_upgrade",title:`Upgrade ${Ho[i]}`,icon:"⬆️",levelText:r?"MAX":`Lv.${s} → Lv.${s+1}`,desc:r?"Maximum power reached":"+Damage, +Crit Chance",cost:r?0:a,color:"#00ddff",canBuy:!r&&t.coins>=a,action:()=>{t.coins-=a,t.weaponLevels[i]++,this.weapons.setWeapon(i,t.weaponLevels[i]),this._playBuySound()}});const l=Go.indexOf(i),h=Go[(l+1)%Go.length],u=10;n.push({id:"switch_weapon",title:`Switch to ${Ho[h]}`,icon:"🔄",levelText:`Currently Lv.${t.weaponLevels[h]||1}`,desc:"Change weapon track completely",cost:u,color:"#ff6b35",canBuy:t.coins>=u,action:()=>{t.coins-=u,t.weaponType=h,this.weapons.setWeapon(h,t.weaponLevels[h]||1),this._playBuySound()}});const c=t.utilityLevels.maxHealth||1,d=c>=10,f=15+(c-1)*10;n.push({id:"max_health",title:"Thick Shell",icon:"❤️",levelText:d?"MAX":`Lv.${c} → Lv.${c+1}`,desc:"+50 Max HP & Full Heal",cost:d?0:f,color:"#44ff88",canBuy:!d&&t.coins>=f,action:()=>{t.coins-=f,t.utilityLevels.maxHealth++,t.maxHealth+=50,t.health=t.maxHealth,this._playBuySound()}});const g=t.utilityLevels.waterCapacity||1,_=g>=10,m=15+(g-1)*10;n.push({id:"water_cap",title:"Deep Reservoir",icon:"💧",levelText:_?"MAX":`Lv.${g} → Lv.${g+1}`,desc:"+50 Ammo Capacity",cost:_?0:m,color:"#44ddff",canBuy:!_&&t.coins>=m,action:()=>{t.coins-=m,t.utilityLevels.waterCapacity++,t.maxAmmo+=50,t.currentAmmo=t.maxAmmo,this._playBuySound()}});const p=t.utilityLevels.burrowStrength||1,x=p>=10,M=20+(p-1)*10;n.push({id:"burrow_hp",title:"Fortified Burrow",icon:"🏰",levelText:x?"MAX":`Lv.${p} → Lv.${p+1}`,desc:"+200 Burrow Max HP & Heal",cost:x?0:M,color:"#ffdd44",canBuy:!x&&t.coins>=M,action:()=>{t.coins-=M,t.utilityLevels.burrowStrength++,this.burrowManager&&(this.burrowManager.maxHealth+=200,this.burrowManager.health+=200),this._playBuySound()}});const v=t.utilityLevels.minionCapacity||1,P=v>=5,C=30+(v-1)*20;n.push({id:"minion_cap",title:"Crab Army",icon:"🦀",levelText:P?"MAX":`Lv.${v} → Lv.${v+1}`,desc:"+1 Minion Capacity",cost:P?0:C,color:"#ff88aa",canBuy:!P&&t.coins>=C,action:()=>{t.coins-=C,t.utilityLevels.minionCapacity++,this.burrowManager&&(this.burrowManager.maxMinions=(this.burrowManager.maxMinions||0)+1),this._playBuySound()}});let E=0,L=!1,w="OFFLINE";if(this.burrowManager&&this.burrowManager.state==="active"){const ne=this.burrowManager.eggs.length+this.burrowManager.minions.length;ne>=this.burrowManager.maxMinions?w="MAX CAPACITY":(E=5*Math.pow(2,ne),w=`${ne}/${this.burrowManager.maxMinions} Alive`,L=t.coins>=E)}n.push({id:"spawn_minion",title:"Hatch Minion",icon:"🥚",levelText:w,desc:"Spawn a minion crab now",cost:L?E:w==="MAX CAPACITY"||w==="OFFLINE"?0:E,color:"#ffaa00",canBuy:L,action:()=>{this.burrowManager&&this.burrowManager.spawnMinion()&&(t.coins-=E,this._playBuySound())}});const S=t.utilityLevels.minionLevel||1,R=S>=5,D=40+(S-1)*30;n.push({id:"upgrade_minion",title:"Minion Power",icon:"💪",levelText:R?"MAX":`Lv.${S} → Lv.${S+1}`,desc:"Increases minion HP & Damage",cost:R?0:D,color:"#dd5555",canBuy:!R&&t.coins>=D,action:()=>{t.coins-=D,t.utilityLevels.minionLevel++,this._playBuySound()}});const I=t.utilityLevels.sandBurst||1,k=I>=5,X=50+(I-1)*40;n.push({id:"upgrade_burst",title:"Sand Burst",icon:"🌪️",levelText:k?"MAX":`Lv.${I} → Lv.${I+1}`,desc:I===1?"+Radius":I===2?"-Cooldown":I===3?"+Damage":"Max Power",cost:k?0:X,color:"#eedd88",canBuy:!k&&t.coins>=X,action:()=>{t.coins-=X,t.utilityLevels.sandBurst++,this._playBuySound()}});const q=t.utilityLevels.jumpPower||1,J=q>=5,V=25+(q-1)*20;n.push({id:"upgrade_jump",title:"Spring Legs",icon:"🦘",levelText:J?"MAX":`Lv.${q} → Lv.${q+1}`,desc:"+Jump height & distance",cost:J?0:V,color:"#88ffaa",canBuy:!J&&t.coins>=V,action:()=>{t.coins-=V,t.utilityLevels.jumpPower++,t.jumpForce=25+(t.utilityLevels.jumpPower-1)*7,this._playBuySound()}}),n.forEach(ne=>{const he=document.createElement("div");he.className="shop-card"+(ne.canBuy?"":" disabled"),he.style.setProperty("--card-color",ne.color);let we="";ne.cost===0?we='<div class="shop-cost">MAX LEVEL</div>':we=`<div class="shop-cost">🪙 ${ne.cost}</div>`,he.innerHTML=`
        ...
        ${we}
      `,ne.canBuy&&he.addEventListener("click",Be=>{ne.action(),this._updateHUD();const Ke=Be.currentTarget;Ke.classList.add("flash-green"),setTimeout(()=>{Ke&&Ke.classList.remove("flash-green"),this._renderCards()},300)}),e.appendChild(he)})}_updateHUD(){const e=this._overlay.querySelector("#shop-coin-count");e&&(e.textContent=this.crab.coins);const t=document.getElementById("coin-count");t&&(t.textContent=this.crab.coins);const n=document.getElementById("gun-tier");n&&(n.textContent=`${Ho[this.crab.weaponType]} Lv.${this.crab.weaponLevels[this.crab.weaponType]}`)}_playBuySound(){}_close(){this.isActive=!1,this._overlay&&(this._overlay.style.animation="upgradeOverlayOut 0.3s forwards",setTimeout(()=>{this._overlay&&(this._overlay.remove(),this._overlay=null)},300)),this._resolve&&(this._resolve(),this._resolve=null)}}var cu=window.Wavedash;if(!cu)throw new Error("Wavedash is not initialized. If you're running your game locally use the `wavedash dev` command to ensure the Wavedash SDK is loaded.");var Sn=cu;const Fv="high-scores";let Vo=null;function pl(){return Vo||(Vo=(async()=>{try{const o=await Sn.getOrCreateLeaderboard(Fv,Sn.LeaderboardSortOrder.DESC,Sn.LeaderboardDisplayType.NUMERIC);return o.success?o.data.id:(console.warn("[wavedash] getOrCreateLeaderboard failed:",o.message),null)}catch(o){return console.warn("[wavedash] getOrCreateLeaderboard error:",o),null}})()),Vo}function Ov(o,e){return Math.max(0,Math.floor(o||0))*1e4+Math.max(0,Math.floor(e||0))}function hu(o){const e=Math.max(0,Math.floor(o||0));return{wave:Math.floor(e/1e4),kills:e%1e4}}async function kv({wave:o,kills:e,coins:t}){try{const n=await pl();if(!n)return null;const i=Ov(o,e),s=await Sn.uploadLeaderboardScore(n,i,!0);return s.success?s.data.globalRank:(console.warn("[wavedash] uploadLeaderboardScore failed:",s.message),null)}catch(n){return console.warn("[wavedash] submitScore error:",n),null}}async function zv(o=10){try{const e=await pl();if(!e)return[];const t=await Sn.listLeaderboardEntries(e,0,o,!1);return t.success?t.data.map(n=>{const{wave:i,kills:s}=hu(n.score);return{name:n.username||"Anonymous",wave:i,kills:s,coins:0,globalRank:n.globalRank,userId:n.userId}}):[]}catch(e){return console.warn("[wavedash] fetchTopScores error:",e),[]}}async function Gv(){try{const o=await pl();if(!o)return null;const e=await Sn.getMyLeaderboardEntries(o);if(!e.success||!e.data||e.data.length===0)return null;const t=e.data[0],{wave:n,kills:i}=hu(t.score);return{entry:{name:t.username||Sn.getUsername()||"You",wave:n,kills:i,coins:0},rank:t.globalRank}}catch(o){return console.warn("[wavedash] fetchPlayerRank error:",o),null}}function Hv(){try{Sn.init({debug:!0});const o=Sn.getUser();if(o)return{username:Sn.getUsername()||o.username||null}}catch{console.info("[wavedash] SDK not available (local dev mode)")}return null}const Vv=.12,Wv=.85;class Xv{constructor(e,t={}){this.input=e,this.onPause=t.onPause||(()=>{}),this.onSandBurst=t.onSandBurst||(()=>{}),this.lookSensitivity=t.lookSensitivity||3,this._touches={},this._moveDX=0,this._moveDY=0,this._maxMoveRadius=56,this._bindEvents()}_el(e){return document.getElementById(e)}_bindEvents(){const e=this._el("move-stick-base"),t=this._el("look-area"),n=this._el("btn-fire"),i=this._el("btn-jump"),s=this._el("btn-burst"),r=this._el("btn-pause");if(!e||!t){console.warn("[TouchControls] mobile UI elements missing");return}e.addEventListener("touchstart",u=>{u.preventDefault(),u.stopPropagation();for(const c of u.changedTouches){if(this._anyKind("move"))continue;const d=e.getBoundingClientRect();this._touches[c.identifier]={kind:"move",baseX:d.left+d.width/2,baseY:d.top+d.height/2},this._updateMoveFromTouch(c)}},{passive:!1}),t.addEventListener("touchstart",u=>{u.preventDefault(),u.stopPropagation();for(const c of u.changedTouches)this._anyKind("look")||(this._touches[c.identifier]={kind:"look",lastX:c.clientX,lastY:c.clientY})},{passive:!1});const a=u=>{let c=!1;for(const d of u.changedTouches){const f=this._touches[d.identifier];if(f){if(c=!0,f.kind==="move")this._updateMoveFromTouch(d);else if(f.kind==="look"){const g=d.clientX-f.lastX,_=d.clientY-f.lastY;f.lastX=d.clientX,f.lastY=d.clientY;const m=Math.sqrt(g*g+_*_),p=1+Math.min(2,m/30);this.input._mouseDeltaX+=g*this.lookSensitivity*p,this.input._mouseDeltaY+=_*this.lookSensitivity*p,this.input.mouse.locked=!0}}}c&&u.preventDefault()},l=u=>{for(const c of u.changedTouches){const d=this._touches[c.identifier];d&&(d.kind==="move"&&(this._moveDX=0,this._moveDY=0,this.input.analogMove=null,this.input._touchSprint=!1,this._renderKnob()),delete this._touches[c.identifier])}};document.addEventListener("touchmove",a,{passive:!1}),document.addEventListener("touchend",l,{passive:!1}),document.addEventListener("touchcancel",l,{passive:!1});const h=(u,c,d)=>{if(!u)return;u.addEventListener("touchstart",g=>{g.preventDefault(),g.stopPropagation(),u.classList.add("pressed"),c()},{passive:!1});const f=g=>{u.classList.remove("pressed"),d&&d()};u.addEventListener("touchend",f,{passive:!1}),u.addEventListener("touchcancel",f,{passive:!1})};h(n,()=>{this.input.mouse.leftDown=!0},()=>{this.input.mouse.leftDown=!1}),h(i,()=>{this.input.keys.space||(this.input._jumpRequested=!0),this.input.keys.space=!0},()=>{this.input.keys.space=!1}),s&&s.addEventListener("touchstart",u=>{u.preventDefault(),u.stopPropagation(),s.classList.add("pressed"),this.onSandBurst(),setTimeout(()=>s.classList.remove("pressed"),120)},{passive:!1}),r&&r.addEventListener("touchstart",u=>{u.preventDefault(),u.stopPropagation(),this.onPause()},{passive:!1})}_anyKind(e){for(const t in this._touches)if(this._touches[t].kind===e)return!0;return!1}_updateMoveFromTouch(e){const t=this._touches[e.identifier];if(!t)return;let n=e.clientX-t.baseX,i=e.clientY-t.baseY;const s=Math.sqrt(n*n+i*i);s>this._maxMoveRadius&&(n=n/s*this._maxMoveRadius,i=i/s*this._maxMoveRadius),this._moveDX=n,this._moveDY=i;const r=n/this._maxMoveRadius,a=i/this._maxMoveRadius,l=Math.min(1,s/this._maxMoveRadius);l<Vv?(this.input.analogMove=null,this.input._touchSprint=!1):(this.input.analogMove={x:r,z:a,magnitude:l},this.input._touchSprint=l>Wv),this._renderKnob()}_renderKnob(){const e=this._el("move-stick-knob");e&&(e.style.transform=`translate(calc(-50% + ${this._moveDX}px), calc(-50% + ${this._moveDY}px))`)}}["log","warn","info","debug","error","trace"].forEach(o=>{console[o]=()=>{}});const Vr=typeof window<"u"?new URLSearchParams(window.location.search):null,qv=Vr&&Vr.get("touch")==="1",Yv=typeof window<"u"&&window.matchMedia?window.matchMedia("(pointer: coarse)").matches:!1,vn=qv||Yv||typeof window<"u"&&("ontouchstart"in window||navigator.maxTouchPoints&&navigator.maxTouchPoints>0);vn&&(document.documentElement.classList.add("touch-mode"),document.body&&document.body.classList.add("touch-mode"));let Ye,Un,ti,Vt,ae,He,Jt,ft,mi,_t,_n,br,Er,Wo=0,Ar=0;const sh=document.getElementById("fps-counter");let Cr=0,yt="MENU";document.addEventListener("DOMContentLoaded",()=>{const o=document.getElementById("game-canvas");if(!o){console.error("Canvas not found");return}vn&&document.body&&document.body.classList.add("touch-mode");const e=()=>{if(!vn)return;const Z=window.innerHeight>window.innerWidth;document.body.classList.toggle("portrait",Z)};e(),window.addEventListener("resize",e),window.addEventListener("orientationchange",e),Ye=new F_(o),Un=new O_,He=new wv,ti=new k_(Ye.camera,Un),Vt=new Mv(Ye.scene),Vt.sand&&ti.addCollisionObject(Vt.sand),ae=new Sv(Ye.scene,Vt,Un,ti),Jt=new Iv(Ye.camera,He),ae.dialogue=Jt,ae.audio=He;let t=!1;if(ae._onDeath=()=>{console.log("💀 Crab died — starting death sequence"),te=!1,yt="DEAD";const Z=["You belong to the deep now… Cthulhu waits below.mp3","Sink without fear… the deep has already claimed you.mp3"],$=Z[Math.floor(Math.random()*Z.length)];(()=>{const O=Jt&&Jt.audioBuffers?Jt.audioBuffers[$]:null;O&&O instanceof AudioBuffer?He.playDeathDialogueWithEcho(O):O&&He&&He.ctx&&He.ctx.decodeAudioData(O.slice(0)).then(z=>{He.playDeathDialogueWithEcho(z)}).catch(()=>{})})();const fe=document.getElementById("death-overlay");fe&&fe.classList.add("dying");const b={wave:_t.currentWave||0,kills:_t.totalKills||0,coins:ae.totalCoinsCollected||0},y=kv(b);setTimeout(()=>{if(t)return;t=!0;try{document.exitPointerLock()}catch{}const O=document.getElementById("death-wave"),z=document.getElementById("death-kills"),W=document.getElementById("death-coins");O&&(O.textContent=b.wave),z&&(z.textContent=b.kills),W&&(W.textContent=b.coins);const Y=document.querySelector("#death-window .death-subtitle");Y&&window.playerName&&(Y.textContent=`${window.playerName}, the abyss has claimed you`);const ve=document.getElementById("death-window");ve&&ve.classList.add("visible"),y.then(()=>p("death-leaderboard",3))},7e3)},ft=new Tv(Ye.scene,He),mi=new Rv(Ye.scene),_t=new Lv(Ye.scene,Vt,He,Jt),_t.crab=ae,window.enemyManager=_t,window.crab=ae,window.world=Vt,window.audio=He,window.weapons=ft,Vr){const Z=parseInt(Vr.get("startWave"),10);Number.isFinite(Z)&&Z>1&&(_t.currentWave=Z-1,Z>=6&&_t._lazyLoadCthulhu(),Z>=4&&_t._lazyLoadBoss())}_n=new Dv(Ye.scene,Vt,He),_n.dialogue=Jt,_n.crab=ae,br=new Uv(Ye.scene),Er=new Bv;const n=document.getElementById("main-menu"),i=document.getElementById("how-to-play"),s=document.getElementById("ui-layer"),r="cota_playerName",a=document.getElementById("name-entry-overlay"),l=document.getElementById("player-name-input"),h=document.getElementById("btn-name-confirm"),u=document.getElementById("player-name-badge"),c=Z=>{const $=String(Z||"").trim().slice(0,20);if(!$)return!1;window.playerName=$;try{sessionStorage.setItem(r,$)}catch{}return u&&(u.textContent=`Playing as ${$}`),!0},d=()=>{if(!c(l.value)){l.focus();return}a.classList.add("hidden"),n.classList.remove("hidden")},f=Hv();let g="";try{g=sessionStorage.getItem(r)||""}catch{}if(f&&f.username?(c(f.username),a.classList.add("hidden"),n.classList.remove("hidden")):g?(c(g),a.classList.add("hidden"),n.classList.remove("hidden")):setTimeout(()=>l&&l.focus(),100),h){let Z=!1;const $=_e=>{Z||(Z=!0,_e&&_e.preventDefault&&_e.preventDefault(),d(),setTimeout(()=>{Z=!1},400))};h.addEventListener("pointerdown",$),h.addEventListener("click",$)}l&&l.addEventListener("keydown",Z=>{Z.key==="Enter"&&(Z.preventDefault(),d())});const _=Z=>String(Z).replace(/[&<>"']/g,$=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[$]);function m(Z,$,_e){return`
    ...
    `}async function p(Z,$=10){const _e=document.getElementById(Z);if(!_e)return;_e.innerHTML='<div class="leaderboard-title">Loading…</div>';const fe=await zv($),b=window.playerName,y=fe.some(ue=>b&&ue.name===b);let O=null,z=null;if(b&&!y){const ue=await Gv();ue&&(O=ue.entry,z=ue.rank)}const W=`<div class="leaderboard-title">Top ${$} Survivors</div>`;if(!fe.length){_e.innerHTML=`${W}<div class="leaderboard-empty">No runs yet — be the first.</div>`;return}const Y=`
